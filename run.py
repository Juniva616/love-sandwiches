...
def get_sales_data():
    ...
    """
    while True:
        print("Please enter the sales data for the last market.")
...
def validate_data(values):
    ...
    Raises valueError if a value cannot be converted to int,
...
def calculate_surplus_data(sales_row):
    ...
    - Positive surplus indicates waist.
...
def  get_stock_values(data):
    """
    Prints recomendations for users about making stocks, taking
    data from worksheet and main() function
    """
